...
===============================================================================
Purpose:
    Loads and transforms data from Bronze tables into Silver tables.

Actions:
    1. Truncates existing Silver tables.
    2. Cleans and transforms Bronze data.
    3. Inserts transformed data into Silver tables.
    4. Displays load duration and row-processing information.
    5. Throws the actual SQL error if loading fails.
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE
                WHEN TRY_CONVERT(DATE, bdate) > CAST(GETDATE() AS DATE)
                    THEN NULL
    ...
    BEGIN CATCH
        ...
        -- Important: show the real SQL Server error
        THROW;
